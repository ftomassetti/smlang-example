...
private fun addTab(tabbedPane: MyTabbedPane, title: String, font: Font, initialContent: String = "",
                   languageSupport: LanguageSupport,
                   file: File? = null) {
    val panel = makeTextPanel(font, languageSupport, initialContent, file)
...
fun createAndShowKanvasGUI() {
    ...
    new.addActionListener { addTab(tabbedPane, "<UNNAMED>", font, languageSupport=miniCalcSupport) }
    fileMenu.add(new)
...
fun main(args: Array<String>) {
    languageSupportRegistry.register("mc", miniCalcSupport)
